...
func main() {
	...
	//tree.Insert("/hello", "test 1")
	//tree.Insert("/world", "test 2")

	//tree.Insert("/hello/world", "test 3")
	tree.Insert("/wtf:param/test", "test 5")
	tree.Insert("/word", "test 4")

	println("Done inserting")
	//println(tree.Search("/hello/world").(string))
	println(tree.Search("/wtflol/test").(string))
	println(tree.Search("/word").(string))
}
